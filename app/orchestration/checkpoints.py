...
class CheckpointManager:
    ...
    async def refresh(self, task_id: UUID) -> ResearchState:
        ...
        return await self._task_repo.load_state(task_id)
    ...
    async def pause_for_approval(self, state: ResearchState) -> ResearchState:
        ...
        await self._task_repo.save_state(state.task_id, state)
        logger.info(
    ...
    async def process_approval(
        ...
        state = await self._task_repo.load_state(task_id)
        ...
        await self._task_repo.save_state(task_id, state)
        logger.info(
